...
def get_args_parser():
    ...
    parser.add_argument('--f_shot', default=1, type=int)
    parser.add_argument('--save_json', action='store_true', help='if save the evaluation json')
    ...
    # lora
    parser.add_argument('--backbone_use_lora', action='store_true')
    parser.add_argument('--bert_use_lora', action='store_true')
