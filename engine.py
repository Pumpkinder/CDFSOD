...
def evaluate(model, criterion, postprocessors, data_loader, base_ds, device, output_dir, wo_class_error=False, args=None, logger=None):
    ...
    if args.save_json:
        ...
        save_path = "./{}/{}/{}shot/epoch{}_inference.json".format(args.inference_dir, args.dataset_name, args.f_shot,args.epoch)
        ...
        with open(save_path, 'w') as f:
            json.dump(json_results, f,ensure_ascii=False, default=default_dump)
        print("JSON file saved as {}".format(save_path))
